...
ActiveRecord::Schema[7.1].define(version: 2024_01_26_032023) do
  ...
  create_table "lessions", charset: "utf8mb3", collation: "utf8mb3_unicode_ci", force: :cascade do |t|
  ...
  add_foreign_key "lessions", "courses", column: "courses_id"
